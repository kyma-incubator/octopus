...
- Automatic retries on failed tests, which is remedy for flaky tests. 
...
- Full support for concurrent testing, which allows you to run a given test concurrently with other tests.
