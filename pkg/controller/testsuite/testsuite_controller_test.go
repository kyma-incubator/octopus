...
func TestReconcile(t *testing.T) {
	...
	instance := &testingv1alpha1.TestSuite{ObjectMeta: metav1.ObjectMeta{Name: "foo"}}
	...
	// Create the TestSuite object and expect the Reconcile and Deployment to be created
